...
public class PantallaInstrucciones implements Screen {
    ...
    public PantallaInstrucciones(SpaceNavigation game) {
        ...
        // Fuentes predeterminadas pero mejor presentadas
    ...
    public void render(float delta) {
        ...
        float startY = 500; // posición base de las instrucciones
        ...
        // efecto de parpadeo usando seno
